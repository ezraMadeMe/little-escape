        ...
        <div className="p-6">
          ...
          <div className="mb-6">
            ...
            <textarea
              ...
              className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 h-40 resize-none"
          ...
          <div className="mb-8">
            ...
            <label
              ...
              className="w-full py-3 px-4 border-2 border-dashed border-gray-300 rounded-lg text-center text-sm text-gray-600 cursor-pointer hover:border-purple-500 hover:text-purple-600 transition flex items-center justify-center gap-2"
            >
